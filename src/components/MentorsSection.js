...
const MentorsSection = () => (
  ...
  <div className="container">
      <div className="features-extended-inner section-inner has-top-divider">
        ...
        <MentorCard title="KAOUSSI Souhail" content="Ceo & Founder @Artisoft.ma" image={Card1}/>
        <MentorCard title="GHALLOU Ismail" content="FullStack Web Developer @Obytes" image={Card2}/>
      </div>
  </div>
</section>
)
